...
for i in 0.0005
do
    CUDA_VISIBLE_DEVICES=14 python main_clip.py \
...
##################################### 231205 ######################################
# CUDA_VISIBLE_DEVICES=1 python main_clip.py \
#                                 --note temp --lr 0.0005 --epochs 20 --batch_size 64 --save_dir '/shared/js.yun/logs/CLAM/temp/'

# # ##################################### 231127 ######################################
# for i in 15
# do
#     CUDA_VISIBLE_DEVICES=14 python main_clip.py --note epoch_tuning --lr 0.0005 --epochs $i
# done

# for i in 0.03125 0.125 0.5 2 8 32 
# do
#     CUDA_VISIBLE_DEVICES=14 python main_clip.py --note wd_tuning --lr 0.0005 --wd $i
# done
...
# feat_dir='/shared/js.yun/data/CLAM_data/TCGA-lung-x256-features-from-random-vitb-img224/'
...
# CUDA_VISIBLE_DEVICES=15 python extract_features_fp.py --data_h5_dir $data_h5_dir \
#                                                         --data_slide_dir $data_slide_dir \
#                                                         --csv_path $csv_path \
#                                                         --feat_dir $feat_dir \
#                                                         --image_encoder 'vitb-img224' \
#                                                         --batch_size 256 \
#                                                         --loader 'default' \
#                                                         --num_worker 4
