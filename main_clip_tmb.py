# main_clip.py에서 clip 모델 학습한 모델을 불러와서 TMB classification 하는 코드
...
import numpy as np
import pandas as pd
from utils.core_utils_clip_tmb import train_wrapper

parser = argparse.ArgumentParser(description='TMB classification aftter CLIP')
...
for i in range(args.folds):
    file_path = os.path.join(args.split_dir, f'splits_{i}.csv')
