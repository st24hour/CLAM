...
for i in 0.005
do
    CUDA_VISIBLE_DEVICES=13 python main_clip.py \
...
# for i in 0.0005
# do
#     CUDA_VISIBLE_DEVICES=2 python main_clip.py \
#                                     --note early_layer2_LN_GELU \
#                                     --genomics_encoder 'Genomics_Encoder_FC_Skip_early_v1' \
#                                     --norm_genom LayerNorm \
#                                     --activation_func_genom GELU \
#                                     --num_layers_genom 2 \
#                                     --lr $i \
#                                     --epochs 20 \
#                                     --batch_size 32 \
...
# for i in 5 10 30
# do
#     CUDA_VISIBLE_DEVICES=14 python main_clip.py --note hp_tuning --lr 0.0005 --epochs $i
# done

# # ##################################### 231127 ######################################
# for i in 0.0005
# do
#     CUDA_VISIBLE_DEVICES=2 python main_clip.py --note wd_tuning --lr $i
# done
...
# for i in 0.3
# do
#     CUDA_VISIBLE_DEVICES=2 python main_tmb.py --drop_out \
#                                         --seed 1 \
#                                         --lr 2e-4 \
#                                         --reg 0.00001 \
#                                         --label_smoothing 0 \
...
##################################### 230911 ######################################
# # # HIPT feature가 4k가 우리거랑 개수가 달라서 직접 4k feature 뽑음
...
# # data_h5_dir='/shared/j.jang/pathai/data/TCGA-lung-patches-4096-test'
# data_h5_dir='/shared/j.jang/pathai/data/TCGA-lung-patches'
...
# csv_path='/shared/j.jang/pathai/data/TCGA-lung-patches/process_list_autogen.csv'

# feat_dir='/shared/js.yun/data/CLAM_data/TCGA-lung-features-DINO-repo-vit-4k/'
# # model_256_path='/shared/js.yun/HIPT/HIPT_original/HIPT_4K/Checkpoints/vit256_small_dino.pth'
# model_256_path='/shared/js.yun/HIPT/HIPT_original/HIPT_4K/Checkpoints/vit256_small_dino.pth'
# model_4k_path='/shared/js.yun/HIPT/HIPT_original/HIPT_4K/Checkpoints/vit4k_xs_dino.pth'

# CUDA_VISIBLE_DEVICES=4,5,6,7 python extract_4k_features_fp.py --data_h5_dir $data_h5_dir \
#                                                         --data_slide_dir $data_slide_dir \
#                                                         --csv_path $csv_path \
#                                                         --feat_dir $feat_dir \
#                                                         --model_256_path $model_256_path \
#                                                         --model_4k_path $model_4k_path \
#                                                         --image_encoder 'HIPT_4k' \
#                                                         --batch_size 16 \
#                                                         --loader 'default' \
#                                                         --num_worker 8
